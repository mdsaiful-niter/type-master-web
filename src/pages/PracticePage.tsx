      ...
      <main className="flex-1 p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">Free practice to improve your typing speed</p>
          </div>
          ...
          <div className="tm-panel mb-6">
            ...
            <div className="p-4 flex items-center gap-4">
              ...
              <div className="ml-auto flex gap-2">
                <button onClick={handleRandomText} className="tm-button">
                  🎲 Random
                </button>
                <button onClick={handleNextText} className="tm-button">
                  Next Text →
                </button>
              </div>
            </div>
          ...
          <div className="tm-panel mb-6">
            <div className="p-4 flex items-center justify-around">
              ...
              <div className="flex gap-2">
                {isPaused ? (
                  <button onClick={resumeTyping} className="tm-button tm-button-primary">
                    Resume
                  </button>
                ) : (
                  <button onClick={pauseTyping} className="tm-button">
                    Pause
                  </button>
                )}
          ...
          {/* Completed Message */}
          {completed && (
            <div className="tm-panel mb-6 p-6 text-center bg-accent/10 border-accent">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button onClick={handleNextText} className="tm-button tm-button-primary">
                  Next Text →
                </button>
              </div>
            </div>
